<template>
  <div>
    <div class="n-layout-page-header">
      <n-card :bordered="false" title="租房">
      ...
      >
        <template #tableTitle>
          <n-button
            ...
            v-if="hasPermission(['/addons/fang/fang/edit'])"
          >
            <template #icon>
              <n-icon>
                <PlusOutlined />
          ...
          <n-button
            ...
            class="min-left-space"
            v-if="hasPermission(['/addons/fang/fang/delete'])"
          >
            <template #icon>
              <n-icon>
                <DeleteOutlined />
...
<script lang="ts" setup>
  ...
  import { List, Export, Delete,View } from '@/api/addons/fang/fang';
  ...
  function handleView(record: Recordable) {
    router.push({ name: 'addons_fang_fang_view', params: { id: record.id } });
  }
  ...
  function handleSearch(record: Recordable) {
    let url ="https://www.hfzfzlw.com/ListingAndRelease/ListingAndReleaseMergeList?strtitle="+record.village+"&page=1&mode=1&source=1";
  ...
  function handleZufang(record: Recordable) {
    let url ="https://hf.lianjia.com/zufang/rco11rs"+record.village+"/";
    window.open(url, '_blank');
  }
