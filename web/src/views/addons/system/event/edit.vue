    ...
    <n-spin :show="loading" description="请稍候...">
      ...
      >
        ...
        >
          ...
          <n-input placeholder="请输入表名" v-model:value="params.name" />
          </n-form-item>

          <n-form-item label="主键" path="pk">
          <n-input placeholder="请输入主键" v-model:value="params.pk" />
          </n-form-item>

          <n-form-item label="事件" path="event">
          <n-input placeholder="请输入事件" v-model:value="params.event" />
          </n-form-item>
...
<script lang="ts" setup>
  ...
  import { Edit, View } from '@/api/addons/system/event';
